...
def main():
    ...
    features,labels,true_labels_for_points,dataset = load_dataset(file_path_to_test_ = 'Datasets/iris/iris.data',
                                                                  delimiter_ = ',', label_position_ = -1)
    run_experiment_with_dataset(true_labels_for_points = true_labels_for_points,
                                dataset = dataset,
                                features = features,
                                loandra_path = loandra_path,
                                execution_path = execution_path,
                                folder_to_load = 'results/iris')
